...
Since the data is imbalanced and we are mostly interested in predicting the majority class ( fully booked=no), specificity with the main metric used to distiguish the best performing model\*\*\*look this up!!
