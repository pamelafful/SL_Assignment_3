...
# listings_data_cleaned_features=subset(listings_data_cleaned_features,select=-predictions)
...
train_subset=listings_data_cleaned_features[inds,]
...
# add the rest of the factor features
...
validation_scaled=cbind(validation_scaled,validation_df[non_num])
...
listings_h2o_validation <- as.h2o(train_scaled)
...
listings_grid <- h2o.grid(
  ...
  validation_frame =listings_h2o_validation,
  activation = "Tanh",
  seed = 1,
  reproducible = TRUE,
...
![NN Grid Search Summary](tune_summ.png){width="703" height="372"}
...
h2o.logloss(best_model, train = TRUE)
h2o.logloss(best_model, valid = TRUE)


#Get prediction on validation
valid_pred=h2o.predict(best_model,listings_h2o_validation)
